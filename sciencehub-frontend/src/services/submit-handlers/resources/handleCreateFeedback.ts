import { FeedbackData } from "@/src/components/cards/resources/CreateFeedbackForm";
import { Operation } from "@/src/contexts/general/ToastsContext";
import { GeneralCreateInput, GeneralCreateOutput } from "@/src/services/create/createGeneralData";
