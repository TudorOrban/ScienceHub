...
import { useProjectVersionsSearch } from "@/src/hooks/fetch/search-hooks/management/useProjectVersionsSearch";
import { useWorkVersionsSearch } from "@/src/hooks/fetch/search-hooks/management/useWorkVersionsSearch";
import {
    CreateSubmissionFormData,
    CreateSubmissionSchema,
    handleCreateSubmission,
} from "@/src/services/submit-handlers/create/handleCreateSubmission";
...
const ProjectVersionGraph = dynamic(
    () => import("@/src/components/visualizations/ProjectVersionGraph")
);
