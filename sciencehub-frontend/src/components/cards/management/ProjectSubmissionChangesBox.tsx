import { ProjectDeltaKey, ProjectSubmission } from "@/src/types/versionControlTypes";
import { ProjectLayout, ProjectLayoutKey, ProjectMetadataKey } from "@/src/types/projectTypes";
import { formatDate, upperCaseFirstLetter } from "@/src/utils/functions";
