...
import { getProjectPageNavigationMenuItems } from "@/src/config/navItems.config";
...
import ProjectEditModeUI from "@/src/modules/version-control-system/components/ProjectEditModeUI";
