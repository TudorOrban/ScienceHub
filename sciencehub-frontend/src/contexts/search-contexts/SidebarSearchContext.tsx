...
/**
 * Context for holding search options for the Sidebar Search (to be implemented).
 */
export const SidebarSearchContext = React.createContext<SidebarSearchContextType | undefined>(
    undefined
);
