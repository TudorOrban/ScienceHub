import { WorkDelta, WorkDeltaKey } from "@/src/types/versionControlTypes";
import {
    FileLocation,
    Work,
    WorkSnakeCaseKey,
...
} from "@/src/types/workTypes";
import { applyTextDiffs } from "./applyTextDiff";
import { metadataVersionedFields } from "@/src/config/worksVersionedFields.config";
import { camelCase } from "@/src/services/fetch/fetchGeneralData";
