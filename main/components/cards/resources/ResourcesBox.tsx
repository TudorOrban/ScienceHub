...
/**
 * Reusable box for Resources pages.
 */
const ResourcesBox: React.FC<ResourcesBoxProps> = ({ label, icon, content, link }) => {
    return (
        <Link
            href={link}
            className="min-w-fit bg-white hover:bg-gray-50 border border-gray-300 hover:border-gray-400 rounded-md shadow-md hover:shadow-lg"
        >
