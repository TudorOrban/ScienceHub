...
export type BrowseReviewsSearchContextType = {
...
/**
 * Context for holding search options for the Browse Reviews page.
 * Listens to user inputed options and translates into key-value pairs for the useAdvancedSearch hook
 */
export const BrowseReviewsSearchContext = React.createContext<
    BrowseReviewsSearchContextType | undefined
>(undefined);

export const useBrowseReviewsSearchContext = (): BrowseReviewsSearchContextType => {
    const context = useContext(BrowseReviewsSearchContext);
    if (!context) {
        throw new Error(
            "Please use BrowseReviewsSearchContext within an BrowseReviewsSearchContextProvider"
        );
    }
    return context;
};

export const BrowseReviewsSearchProvider: React.FC<{
    ...
    return (
        <BrowseReviewsSearchContext.Provider
            value={{
                searchByField,
                searchByCategory,
